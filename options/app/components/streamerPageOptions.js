	...
	template: `
		<div class="settings-section">
			...
			<div class="settings-section-settings">
				...
				<checkbox-toggle :value.sync="autoTheater" @changed="saveSettings()" label="Auto Theater Mode" tooltip="Automatically enters the immersive Theater Mode. NOTE: Will not work when a Co-Stream is active."></checkbox-toggle>
